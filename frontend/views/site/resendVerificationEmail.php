...
/**
 * Clinical Curator — Resend Verification Email View
 *
 * @var \yii\web\View                      $this
 * @var app\models\ResendVerificationEmailForm $model
 *
 * Controller: SiteController::actionResendVerificationEmail()
 *   $this->layout = 'guest';
 */
...
$this->title = 'Resend Verification Email | Clinical Curator';
$this->params['brandSubtitle'] = 'Account Recovery';
?>

<!-- ════════════════════════════════════════════════════════════════════════════
     Verification Email Resend Card
     ════════════════════════════════════════════════════════════════════════════ -->
<div class="bg-surface-container-lowest/80 backdrop-blur-xl rounded-xl p-10
    ...
    <div class="mb-8">
        <h2 class="text-xl font-bold text-on-surface mb-2">Resend Verification Email</h2>
        <p class="text-on-surface-variant text-sm">
            Enter your institutional email address and we will send a new verification link.
        </p>
    </div>
